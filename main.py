class Counter:
    ...
    def set_current(self, start):
        if self.min_value <= start <= self.max_value:
            ...
            raise ValueError(f"Start value {start} is out of bounds")
    ...
    def set_max(self, max_max):
        if max_max >= self.min_value:
            ...
            raise ValueError(f"Max value {max_max} is less than min value {self.min_value}")
    ...
    def set_min(self, min_min):
        if min_min <= self.max_value:
            ...
            raise ValueError(f"Min value {min_min} is greater than max value {self.max_value}")
